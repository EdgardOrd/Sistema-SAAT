...
if(!empty($_GET["fecha_inicial"]) and !empty($_GET["fecha_final"]))
{
   ...
   class PDF extends FPDF
   {
      ...
      function Header()
      {
         ...
         $this->Image('cah.jpeg', 10, 10, 35); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
         ...
         $this->Cell(75, 10, utf8_decode("REPORTE DE PROYECTOS DESAPROBADOS"), 0, 1, 'C', 0);
   ...
   $consulta_reporte = $conexion->conexion->query("CALL SP_DESAPROBADOS_CAH('$fecha_inicial','$fecha_final')");
   ...
   $pdf->Cell(50, 10, utf8_decode($datos_reporte->clave_catastral), 1, 0, 'C', 0);
   ...
   $pdf->Output("ReporteDesaprobadosCAH-$fecha_inicial-$fecha_final.pdf", 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
}
else
{
