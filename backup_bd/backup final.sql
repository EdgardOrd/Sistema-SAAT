...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_MILLONARIOS_CIMEQH`(
    IN fecha_inicial DATE,
    IN fecha_final DATE
)
BEGIN
    SELECT num_expediente,presupuesto,area, clave_catastral, propietario, fecha 
    FROM proyectoscimeqh
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REGISTRAR_APROBADO_CAH`(IN EXPE VARCHAR(45),IN PROYECT VARCHAR(100), IN PROPI VARCHAR(50), IN CLAVE VARCHAR(100),IN DATO_AREA FLOAT, IN PRESUPUESTO FLOAT, IN OBSERVACIONES VARCHAR(100), IN FECHA DATE)
BEGIN 
	INSERT INTO proyectoscah(num_expediente,tipo_proyecto,propietario,clave_catastral,area,presupuesto,estatus,observaciones,fecha) VALUES (EXPE,PROYECT,PROPI,CLAVE,DATO_AREA,PRESUPUESTO,'1',OBSERVACIONES,FECHA);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REGISTRAR_APROBADO_CICH`(IN EXPE VARCHAR(45),IN PROYECT VARCHAR(100), IN PROPI VARCHAR(50), IN CLAVE VARCHAR(100),IN DATO_AREA FLOAT, IN PRESUPUESTO FLOAT, IN OBSERVACIONES VARCHAR(100), IN FECHA DATE)
BEGIN 
	INSERT INTO proyectoscich(num_expediente,tipo_proyecto,propietario,clave_catastral,area,presupuesto,estatus,observaciones,fecha) VALUES (EXPE,PROYECT,PROPI,CLAVE,DATO_AREA,PRESUPUESTO,'1',OBSERVACIONES,FECHA);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REGISTRAR_APROBADO_CIMEQH`(IN EXPE VARCHAR(45),IN PROYECT VARCHAR(100), IN PROPI VARCHAR(50), IN CLAVE VARCHAR(100),IN DATO_AREA FLOAT, IN PRESUPUESTO FLOAT, IN OBSERVACIONES VARCHAR(100), IN FECHA DATE)
BEGIN 
	INSERT INTO proyectoscimeqh(num_expediente,tipo_proyecto,propietario,clave_catastral,area,presupuesto,estatus,observaciones,fecha) VALUES (EXPE,PROYECT,PROPI,CLAVE,DATO_AREA,PRESUPUESTO,'1',OBSERVACIONES,FECHA);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
