...
$pdf->Cell(96, 10, utf8_decode("Nombre del Proyecto:"), 0, 0, '', 0);
$pdf->Ln(6);

/* TELEFONO */
$pdf->Cell(1);  // mover a la derecha
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(59, 10, utf8_decode("Catastral:"), 0, 0, '', 0);
$pdf->Ln(6);

/* COREEO */
$pdf->Cell(1);  // mover a la derecha
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(85, 10, utf8_decode("Nombre de Proyecto:"), 0, 0, '', 0);
$pdf->Ln(6);

/* FECHA */
$pdf->Cell(1);  // mover a la derecha
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(96, 10, utf8_decode("Fecha:"), 0, 0, '', 0);
$pdf->Ln(22);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(96, 10, utf8_decode("___________________"), 0, 0, '', 0);
$pdf->Ln(5);

$pdf->Cell(10);  // mover a la derecha
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(96, 10, utf8_decode("Ing. Horacio Ruiz"), 0, 0, '', 0);
$pdf->Ln(5);
