...
if(!empty($_GET["fecha_inicial"]) and !empty($_GET["fecha_final"]))
{
   ...
   function __construct($fecha_inicial, $fecha_final)
   {
      ...
      function Header()
      {
         ...
         $this->Cell(75, 10, utf8_decode("REPORTE DE PROYECTOS APROBADOS Y EN SOLICITUD DE SEGUIMIENTO"), 0, 0, 'C', 0);
         $this->Ln(9);
   ...
   $pdf->Output("ReporteAprobadosCAH-$fecha_inicial-$fecha_final.pdf", 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
}
else
{
