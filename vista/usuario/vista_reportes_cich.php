  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form onsubmit="window.open('../vista/fpdf/ReporteSoliDocCich.php?fecha_inicial=' + encodeURIComponent(document.getElementById('fi3').value) + '&fecha_final=' + encodeURIComponent(document.getElementById('ff3').value), '_blank');">
        ...
        <h4 class="text-center">REPORTE DE PROYECTOS ORDENADOS EN BASE A TIPO DE CONSTRUCCIÓN</h4><br>
        ...
        <form>
              <div class="col-lg-3">
                <label for="">Fecha Inicial</label>
                <input type="date" class="form-control" id="fi8" name = "fi8" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich2.php', 'barChart_cich_presupuesto', 'fi8', 'ff8'); llenarTablaPresupuesto('../controlador/colegios/controlador_grafico_cich2.php')">
                <br>
                <label for="">Fecha Final</label>
                <input type="date" class="form-control" id="ff8" name="ff8" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich2.php', 'barChart_cich_presupuesto', 'fi8', 'ff8'); llenarTablaPresupuesto('../controlador/colegios/controlador_grafico_cich2.php')">
                <br>
              </div>
              <div class="col-lg-14">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              ...
                              <div class="card card-success">
                                  ...
                                  <div class="card-body">
                                      <div class="chart">
                                          <canvas id="barChart_cich_presupuesto" style="min-height:230px; max-height:230px;width:200px"></canvas>
                                      </div>
                                  </div>
                              </div>
                          </div>
        ...
        <form>
              <div class="col-lg-3">
                <label for="">Fecha Inicial</label>
                <input type="date" class="form-control" id="fi9" name = "fi9" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich1.php', 'barChart_cich_area', 'fi9', 'ff9'); llenarTablaArea('../controlador/colegios/controlador_grafico_cich1.php')">
              
                <br>
                <label for="">Fecha Final</label>
                <input type="date" class="form-control" id="ff9" name="ff9" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich1.php', 'barChart_cich_area', 'fi9', 'ff9'); llenarTablaArea('../controlador/colegios/controlador_grafico_cich1.php')">
                      ...
                      <div class="row">
                          <div class="col-md-12" >
                              ...
                              <div class="card card-success" id="card_area">
                                  <div class="card-header">
                                      <h3 class="card-title">Gráfico En Base A Las Áreas en Metros Cuadrados</h3>
                                  </div>
                                  <div class="card-body">
                                      <div class="chart ">
                                          <canvas id="barChart_cich_area" style="min-height:230px; max-height:230px;width:200px"></canvas>
                                      </div>
                                  </div>
                              </div>
                          </div>
        ...
        <form>
              <div class="col-lg-3">
              <label for="">Fecha Inicial</label>
                <input type="date" class="form-control" id="fi5" name = "fi5" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich3.php', 'barChart_cich_inspeccion', 'fi5', 'ff5'); llenarTablaInspeccion('../controlador/colegios/controlador_grafico_cich3.php')">
                <br>
                <label for="">Fecha Final</label>
                <input type="date" class="form-control" id="ff5" name="ff5" onchange="cargarDatosGrafico('../controlador/colegios/controlador_grafico_cich3.php', 'barChart_cich_inspeccion', 'fi5', 'ff5'); llenarTablaInspeccion('../controlador/colegios/controlador_grafico_cich3.php')">
                </div> 
              <br>
              <div class="col-lg-14">
              <section class="content">          
                      ...
                      <div class="row">
                          <div class="col-md-12" >
                              ...
                              <div class="card card-success" id="card_inspeccion">
                                  ...
                                  <div class="card-body">
                                      <div class="chart">
                                          <canvas id="barChart_cich_inspeccion" style="min-height:230px; max-height:230px;width:200px"></canvas>
                                      </div>
                                  </div>
                              </div>
                          </div>
              ...
              <section class="content">          
                ...
                <br>
              <button onclick="printCanvasInspeccion()" type="button" name="report_cich_inspeccion" class="btn btn-primary p-3 ml-4 mt-2 w-45 w-sm-50" target="_blank"><i class="fas fa-download me-2 mr-2"></i>Descargar Reporte</button>
            </form>
        </div>
        <div class="tab-pane" id="tab_8">
        <h4 class="text-center">REPORTE DE EXPEDIENTES CON CAMBIO DE INGENIERO DE OBRA</h4><br>
            <form onsubmit="window.open('../vista/fpdf/ReporteDescontinuadoCich.php?fecha_inicial=' + encodeURIComponent(document.getElementById('fi6').value) + '&fecha_final=' + encodeURIComponent(document.getElementById('ff6').value), '_blank');">
              <div class="col-lg-3">
              <label for="">Fecha Inicial</label>
        ...
        <h4 class="text-center">REPORTE DE PROYECTOS MILLONARIOS</h4><br>
...
<script>    
        ...
        function printCanvasPresupuesto() 
        {
            ...
            var canvas = document.getElementById("barChart_cich_presupuesto");
            ...
            img.onload = function() 
            {
              ...
              doc.addImage(this, 'JPEG', 242, 5, 45, 40);
              ...
              doc.save(`ReportedeProyectosxPresupuestoCICH${fecha.fechaInicial}-${fecha.fechaFinal}.pdf`);
              });
            }

            // Cargar la imagen
            img.src = '../vista/fpdf/cich.jpeg';
       ...
       function printCanvasArea()
       {
        var fecha = getFecha("fi9","ff9");
            ...
            var canvas = document.getElementById("barChart_cich_area");
            // Crear un objeto Image
            var img = new Image();
            // Configurar la imagen
            img.onload = function() 
            {
              ...
              // Guardar el documento PDF con un nombre dinámico
              doc.save(`ReportedeProyectosxÁreaCICH${fecha.fechaInicial}-${fecha.fechaFinal}.pdf`);
              });
            }
       ...
       function printCanvasInspeccion()
       {
        var fecha = getFecha("fi5","ff5");
            ...
            var canvas = document.getElementById("barChart_cich_inspeccion");
            // Crear un objeto Image
            var img = new Image();
            // Configurar la imagen
            img.onload = function() 
            {
              ...
              // Guardar el documento PDF con un nombre dinámico
              doc.save(`ReportedeProyectosInspecciónCICH${fecha.fechaInicial}-${fecha.fechaFinal}.pdf`);
              });
            }
            // Cargar la imagen
            img.src = '../vista/fpdf/cich.jpeg';
