...
<head>
  ...
  <title>CAH</title>
  <link rel="icon" type="image/png" href="images/icons/cah.ico"/>
  <link rel="stylesheet" href="../vista/estilo_colegios/cah.css">
      ...
      <div class="col-md-12">
        <div class="card card-warning card-solid">
          ...
          <div class="d-flex justify-content-center">
            <div class="imag_cah">
              <img src="../vista/fpdf/cah.jpeg" alt="logo_cah">
            </div>
          </div>
          <!-- ************************************************************************************************ -->
          <div class="container">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Colegio Cah</h5>
...
<script>
  let idioma_espanol = {
			...
			"sLengthMenu":     "Mostrar _MENU_ registros de CAH",
