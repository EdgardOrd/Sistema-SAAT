...
<head>
    ...
    <link rel="icon" type="image/png" href="../vista/images_ticket/factura.png"/>
    <link rel="stylesheet" href="../vista/index_ticket.css">
...
<body>
        <nav class="navbar navbar-light" style="background-color: #0e285d;">
            <div class="container-fluid">
                <a class="navbar-brand" href="../controlador/usuario/controlador_cerrar_session.php">
        ...
        <div class="container-login100" style="background-image: url('../vista/images_ticket/fondo.svg');">
            <div class="container">
                ...
                <div class="rigth_content">
                    <img src="../vista/images_ticket/cimeqh.jpeg" class="img-fluid" alt="cimeqh">             
                </div>
            </div>
        </div>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
</body>
<script src="../vista/index_ticket.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
    var typed = new Typed(".auto-type",{
        strings:["CIMEQH", "CICH", "CAH"],
        typeSpeed : 80,
        backSpeed : 80,
        loop:true
    })
